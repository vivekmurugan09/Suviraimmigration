...
files.forEach(f => {
    ...
    if (match) {
        ...
        content = content.replace(navLinksRegex, '$1' + navLinksContent + '$3');
    }
    ...
    if (mobileMatch) {
        ...
        content = content.replace(mobileNavRegex, '$1' + mobileNavContent + '$3');
    }
    
    fs.writeFileSync(path.join(dir, f), content);
});
console.log('Fixed navbars correctly');
